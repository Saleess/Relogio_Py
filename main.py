...
light = PhotoImage(file='ensolarado.png')
dark = PhotoImage(file='lua-crescente.png')
...
tela = ttk.Canvas(root, width=600, height=20, bg='#1d1d1d',
                  bd=0, highlightthickness=0, relief='ridge')
tela.pack()
saudacao = Label(root, bg= '#1d1d1d', fg='#8e27ea', font=('Monstserrat', 14))
saudacao.pack()
data = Label(root, bg= '#1d1d1d', fg='#8e27ea', font=('Monstserrat',14))
data.pack(pady=2)
